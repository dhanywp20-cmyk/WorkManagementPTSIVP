  ...
  return (
    <div className="flex items-center justify-center py-24">
      <div className="flex flex-col items-center gap-3">
        <div className="w-9 h-9 rounded-full border-[3px] border-gray-200 border-t-pink-500 animate-spin" />
  ...
  return (
    <div className="w-56 shrink-0 overflow-y-auto flex flex-col gap-1 p-3 border-r border-gray-200" style={{ background: '#f8fafc' }}>
      <div className="flex items-center justify-between mb-2 px-1">
        ...
        {canManage && (
          <button onClick={onAdd} className="text-[11px] font-bold px-2 py-0.5 rounded-lg transition-colors text-pink-600 bg-pink-50 border border-pink-200 hover:bg-pink-100">
            + Folder
          </button>
        )}
      </div>
...
const inputCls = [
  ...
  'placeholder-slate-400 bg-gray-50 border border-gray-200 focus:border-pink-400 focus:ring-2 focus:ring-pink-100',
].join(' ');
    ...
    <div className="flex flex-col h-screen font-sans bg-gray-50"
      ...
      <header className="shrink-0 sticky top-0 z-30 w-full"
        ...
        <div className="flex items-center gap-3 px-6 py-3.5">
          ...
          <div>
            <h1 className="font-black text-[16px] leading-tight tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-pink-600 to-pink-800">Tech Note R&D</h1>
          ...
          <div className="ml-auto flex items-center gap-3">
            <select value={year} onChange={e=>setYear(Number(e.target.value))}
              className="text-slate-700 text-sm font-bold outline-none rounded-xl px-3 py-1.5 bg-gray-100 border border-gray-200 focus:border-pink-400">
                ...
                {filtered.map(tn => {
                  ...
                  return (
                    <div key={tn.id} onClick={()=>openDetail(tn)}
                      className="rounded-2xl p-4 cursor-pointer transition-all group bg-white border border-gray-200 hover:border-pink-300 hover:shadow-md"
                      ...
                      <h4 className="font-bold text-[14px] text-slate-800 leading-snug mb-1.5 group-hover:text-pink-600 transition-colors">{tn.title}</h4>
