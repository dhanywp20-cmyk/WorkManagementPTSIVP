      ...
      <div className="p-8 grid grid-cols-1 gap-4">
        {filteredSessions.length === 0 && (
          <div className="text-center py-16 text-slate-400">
            ...
            <p className="font-semibold">{search ? 'Tidak ada quiz yang cocok' : 'Belum ada quiz aktif'}</p>
            {!search && <p className="text-sm mt-1">Tunggu admin membuat sesi quiz baru</p>}
          </div>
        )}
